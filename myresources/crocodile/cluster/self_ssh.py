...
class SelfSSH:
    ...
    def run_py(self, cmd: str, verbose=False): return None
    ...
    def get_repr(self, which: str, add_machine=False): return f"SelfSSH({which})"
    def open_console(self, cmd: str = "", shell="powershell"): return tb.Terminal().run_async("-i", new_window=True, shell=shell)
