...
from crocodile.cluster.distribute import Cluster, RemoteMachineConfig, ThreadLoadCalculator, LoadCriterion
...
class ExpensiveComputation:
    ...
    def run(self, ms):
        ic = ThreadLoadCalculator(num_jobs=7, load_criterion=LoadCriterion.cpu, reference_machine="this_machine")
