...
from typing import Union, Any, Optional, Callable, Protocol
...
class Scheduler:
    def __init__(self, routine: Callable[['Scheduler'], Any], wait: Union[str, int, float] = "2m", max_cycles: int = 10000000000,
                 ...
                 logger: Optional[LoggerTemplate] = None, sess_stats: Optional[Callable[['Scheduler'], dict[str, Any]]] = None, records: Optional[list[list[Any]]] = None):
